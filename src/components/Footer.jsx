    ...
    return (
        <footer className="text-white py-20 bg_gradient ">
            <div className="container mx-auto px-20 lg:px-20 py-20 flex flex-col gap-10 md:flex-row justify-between border-t border-slate-800">
                <div className="flex">
                    <p className="font-bold text-center">
                        Curry<span className=" text-blue-500 text-xl">Quest</span>
                    </p>
                </div>
            ...
            <div className="flex items-center justify-center py-10">
                ...
                <span className="text-white leading-10 bg-blue-500 px-3 py-1 rounded-full text-sm">Made with love by Lonewolf &#9829;</span>
            </div>
        </footer>
    )
}
